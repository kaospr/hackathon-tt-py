...
# ---------------------------------------------------------------------------
# Method signatures: Python method name -> full def line (without body)
# ---------------------------------------------------------------------------

_METHOD_SIGNATURES: dict[str, str] = {
    "_calculate_overall_performance": "def _calculate_overall_performance(self, positions):",
    "_get_performance_calculation_type": "def _get_performance_calculation_type(self):",
    "_get_symbol_metrics": "def _get_symbol_metrics(self, chart_date_map, data_source, end, exchange_rates, market_symbol_map, start, symbol):",
    "_compute_snapshot": "def _compute_snapshot(self):",
    "_compute_transaction_points": "def _compute_transaction_points(self):",
    "_get_chart_date_map": "def _get_chart_date_map(self, end_date, start_date, step):",
    "get_performance": "def get_performance(self):",
    "get_investments": "def get_investments(self, group_by=None):",
    "get_investments_by_group": "def get_investments_by_group(self, data, group_by):",
}
...
# ---------------------------------------------------------------------------
# The stub calculator — returned when no methods are translated yet
# ---------------------------------------------------------------------------
...
# ---------------------------------------------------------------------------
# File header (imports + class declaration + __init__)
# ---------------------------------------------------------------------------
...
# ---------------------------------------------------------------------------
# Internal methods that are always generated (not from TS translation)
# ---------------------------------------------------------------------------
